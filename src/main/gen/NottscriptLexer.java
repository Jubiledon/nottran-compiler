...
public class NottscriptLexer extends Lexer {
	...
	private static String[] makeRuleNames() {
		return new String[] {
			"T__0", "PROGRAM", "END", "INTEGER", "LOGICAL", "READ", "WRITE", "IF", 
			"THEN", "ELSE", "ENDIF", "TRUE", "FALSE", "LT", "LE", "GT", "GE", "EQ", 
			"NEQ", "ASSIGN", "LPAREN", "RPAREN", "COMMA", "INTLIT", "ID", "WS"
		};
	}
	...
	public NottscriptLexer(CharStream input) {
		super(input);
